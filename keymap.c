...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  RGB_TOG, KC_NLCK, KC_INS,  KC_MPLY, KC_PENT,
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_F19,  KC_F20,  KC_F21,  KC_F22,  KC_F23,  KC_F24,  RGB_MOD, KC_SLCK, KC_PSCR, KC_APP,  KC_PENT,
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |BL Cyc|BL bth|MUSmod|AudTog|Clicky|Macro1|Macro2|Rec 1 |Rec 2 |MsAcc2|MsAcc1|MsAcc0|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |BL Tog|Voice-|Voice+|Mus on|Musoff|MIDIon|MIDIof|Mouse5|Mouse4|Mouse3|Mouse2|Mouse1|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |MWhelL|MWhelD|MWhelU|MWhelR|      |             |      |MouseL|MouseD|MouseU|MouseR|
 * `-----------------------------------------------------------------------------------'
 */
[_ADJUST] = LAYOUT_planck_grid(
    RESET,   DEBUG,   RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD,         RGB_VAI,         RGB_VAD,        RGB_SPI,        RGB_SPD, PLOVER,  KC_SLEP,
    BL_STEP, BL_BRTG, MU_MOD,  AU_TOG,  CK_TOGG, DYN_MACRO_PLAY1, DYN_MACRO_PLAY2, DYN_REC_START1, DYN_REC_START2, KC_ACL2, KC_ACL1, KC_ACL0,
    BL_TOGG, KC_BRIU, KC_BRID, MU_ON,   MU_OFF,  MI_ON,           MI_OFF,          KC_BTN5,        KC_BTN4,        KC_BTN3, KC_BTN2, KC_BTN1,
    KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, _______, _______,         _______,         _______,        KC_MS_L,        KC_MS_D, KC_MS_U, KC_MS_R
)
