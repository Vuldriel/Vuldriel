...
/* Raise
 * ,-----------------------------------------------------------------------------------.
 * |Print | Play | Menu |Scroll|NumLck|Insert|Blueth| LOCK |Scren+|Scren-|RGBMod|RGBTog|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |      |      |      |      |      | Bksp |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Del  |      |      |      |      |      |      |   _  |   +  |   {  |   }  |  |   |
...
[_RAISE] = LAYOUT_preonic_grid(
  KC_PSCR, KC_MPLY, KC_APP,  KC_SLCK, KC_NLCK, KC_INS,  OUT_AUTO, KC_LOCK, KC_BRID, KC_BRIU, RGB_MOD, RGB_TOG, 
  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,  KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BSPC, 
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |BLCycl|BLBret|MusicM|AudTog|Clicky|Macro1|Macro2| Rec1 | Rec2 |MsAcc2|MsAcc1|MsAcc0|
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |BL Tog|Voice-|Voice+|Mus on|MusOff|MidiOn|MidOff|Mouse5|Mouse4|Mouse3|Mouse2|Mouse1|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |MWhelL|MWhelD|MWhelU|MWhelR|      |             |      |MousLt|MousDn|MousUp|MousRt|
 * `-----------------------------------------------------------------------------------'
 */
[_ADJUST] = LAYOUT_preonic_grid(
 KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_F17,  KC_F18,  KC_F19,  KC_F20,  KC_F21,  KC_F22,  KC_F23,  KC_F24, 
 RESET,   DEBUG,   RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, RGB_SPI, RGB_SPD, PLOVER,  KC_SLEP, 
 BL_STEP, BL_BRTG, MU_MOD,  AU_TOG,  CK_TOGG, DM_PLY1, DM_PLY2, DM_REC1, DM_REC2, KC_ACL2, KC_ACL1, KC_ACL0, 
 BL_TOGG, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  KC_BTN5, KC_BTN4, KC_BTN3, KC_BTN2, KC_BTN1, 
 KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R
)
