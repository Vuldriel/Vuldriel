...
#define STARTUP_SOUND H__NOTE(_A4), H__NOTE(_B4), H__NOTE(_C5), H__NOTE(_D5), Q__NOTE(_AS4), W__NOTE(_B4), H__NOTE(_G4), B__NOTE(_A4),

#define GOODBYE_SOUND E__NOTE(_E6), E__NOTE(_A5), ED_NOTE(_E4),
...
//#define PLOVER_SOUND E__NOTE(_GS5), E__NOTE(_A5), S__NOTE(_REST), ED_NOTE(_E6), S__NOTE(_REST), ED_NOTE(_A6),

#define PLOVER_SOUND W__NOTE(_G5), Q__NOTE(_REST), H__NOTE(_G3), H__NOTE(_REST), W__NOTE(_G5), Q__NOTE(_REST), H__NOTE(_G3), H__NOTE(_REST), W__NOTE(_G5), Q__NOTE(_REST), H__NOTE(_G3), H__NOTE(_REST), W__NOTE(_DS5), Q__NOTE(_REST), H__NOTE(_DS3), Q__NOTE(_REST), Q__NOTE(_AS5), W__NOTE(_G5), Q__NOTE(_REST), H__NOTE(_G3), H__NOTE(_REST), W__NOTE(_DS5), Q__NOTE(_REST), H__NOTE(_DS3), Q__NOTE(_REST), Q__NOTE(_AS5), W__NOTE(_G5),

//#define PLOVER_GOODBYE_SOUND E__NOTE(_GS5), E__NOTE(_A5), S__NOTE(_REST), ED_NOTE(_A6), S__NOTE(_REST), ED_NOTE(_E6),

#define PLOVER_GOODBYE_SOUND HALF_DOT_NOTE(_E5), E__NOTE(_REST), W__NOTE(_FS5), W__NOTE(_A5), HALF_DOT_NOTE(_B5), E__NOTE(_REST), W__NOTE(_E5), W__NOTE(_GS5), HALF_DOT_NOTE(_A5), E__NOTE(_REST), W__NOTE(_D5), W__NOTE(_FS5), HALF_DOT_NOTE(_B5), E__NOTE(_REST), W__NOTE(_A5), W__NOTE(_GS5), W__NOTE(_FS5), W__NOTE(_GS5), WHOLE_DOT_NOTE(_A5),

//#define MUSIC_ON_SOUND E__NOTE(_A5), E__NOTE(_B5), E__NOTE(_CS6), E__NOTE(_D6), E__NOTE(_E6), E__NOTE(_FS6), E__NOTE(_GS6), E__NOTE(_A6),

#define MUSIC_ON_SOUND H__NOTE(_C5), H__NOTE(_D5), H__NOTE(_E5), H__NOTE(_C5), H__NOTE(_G5), H__NOTE(_C5), H__NOTE(_C6), H__NOTE(_B5), H__NOTE(_A4), H__NOTE(_B5), H__NOTE(_C6), H__NOTE(_REST), H__NOTE(_B5), H__NOTE(_REST), HALF_DOT_NOTE(_G5), E__NOTE(_FS5), E__NOTE(_F5), B__NOTE(_E5),
...
#define MUSIC_OFF_SOUND Q__NOTE(_A6), S__NOTE(_A4), S__NOTE(_GS4), S__NOTE(_G4), S__NOTE(_FS4), S__NOTE(_F4), S__NOTE(_E4), S__NOTE(_DS4), S__NOTE(_D4), S__NOTE(_CS4), S__NOTE(_C4), S__NOTE(_B3), S__NOTE(_AS3), S__NOTE(_A3),

#define VOICE_CHANGE_SOUND Q__NOTE(_A4), Q__NOTE(_CS5), Q__NOTE(_E5), Q__NOTE(_A5),

#define CHROMATIC_SOUND Q__NOTE(_A4), Q__NOTE(_AS4), Q__NOTE(_B4), Q__NOTE(_C5), Q__NOTE(_CS5),

#define MAJOR_SOUND Q__NOTE(_A4), Q__NOTE(_B4), Q__NOTE(_CS5), Q__NOTE(_D5), Q__NOTE(_E5),

#define MINOR_SOUND Q__NOTE(_A4), Q__NOTE(_B4), Q__NOTE(_C5), Q__NOTE(_D5), Q__NOTE(_E5),

#define GUITAR_SOUND Q__NOTE(_E4), Q__NOTE(_A4), Q__NOTE(_D5), Q__NOTE(_G5),

#define VIOLIN_SOUND Q__NOTE(_G4), Q__NOTE(_D5), Q__NOTE(_A5), Q__NOTE(_E6),

//#define CAPS_LOCK_ON_SOUND E__NOTE(_A3), E__NOTE(_B3),

#define CAPS_LOCK_ON_SOUND Q__NOTE(_B5), B__NOTE(_E6),

//#define CAPS_LOCK_OFF_SOUND E__NOTE(_B3), E__NOTE(_A3),

#define CAPS_LOCK_OFF_SOUND H__NOTE(_AS4), H__NOTE(_C5), H__NOTE(_CS5), H__NOTE(_AS4), W__NOTE(_F5), H__NOTE(_REST), W__NOTE(_F5), H__NOTE(_REST), B__NOTE(_DS5),

//#define SCROLL_LOCK_ON_SOUND E__NOTE(_D4), E__NOTE(_E4),

#define SCROLL_LOCK_ON_SOUND Q__NOTE(_G5), H__NOTE(_REST), Q__NOTE(_G5), H__NOTE(_REST), Q__NOTE(_G5), H__NOTE(_REST), BREVE_DOT_NOTE(_DS5),

//#define SCROLL_LOCK_OFF_SOUND E__NOTE(_E4), E__NOTE(_D4),

#define SCROLL_LOCK_OFF_SOUND Q__NOTE(_F5), H__NOTE(_REST), Q__NOTE(_F5), H__NOTE(_REST), Q__NOTE(_F5), H__NOTE(_REST), BREVE_DOT_NOTE(_D5),

//#define NUM_LOCK_ON_SOUND E__NOTE(_D5), E__NOTE(_E5),

#define NUM_LOCK_ON_SOUND Q__NOTE(_E4), H__NOTE(_REST), Q__NOTE(_E4), H__NOTE(_REST), Q__NOTE(_E4), H__NOTE(_REST), BREVE_DOT_NOTE(_E5),

//#define NUM_LOCK_OFF_SOUND E__NOTE(_E5), E__NOTE(_D5),

#define NUM_LOCK_OFF_SOUND Q__NOTE(_FS4), H__NOTE(_REST), Q__NOTE(_FS4), H__NOTE(_REST), Q__NOTE(_FS4), H__NOTE(_REST), BREVE_DOT_NOTE(_FS5),
