...
#define STARTUP_SOUND H__NOTE(_A5), H__NOTE(_B5), H__NOTE(_C6), H__NOTE(_D6), Q__NOTE(_AS5), W__NOTE(_B5), H__NOTE(_G5), B__NOTE(_A5),
...
#define MUSIC_ON_SOUND H__NOTE(_C6), H__NOTE(_D6), H__NOTE(_E6), H__NOTE(_C6), H__NOTE(_G6), H__NOTE(_C6), H__NOTE(_C7), H__NOTE(_B6), H__NOTE(_A5), H__NOTE(_B6), H__NOTE(_C7), H__NOTE(_REST), H__NOTE(_B6), H__NOTE(_REST), HALF_DOT_NOTE(_G6), E__NOTE(_FS6), E__NOTE(_F6), B__NOTE(_E6),
...
#define MUSIC_OFF_SOUND HALF_DOT_NOTE(_E6), E__NOTE(_REST), W__NOTE(_FS6), W__NOTE(_A6), HALF_DOT_NOTE(_B6), E__NOTE(_REST), W__NOTE(_E6), W__NOTE(_GS6), HALF_DOT_NOTE(_A6), E__NOTE(_REST), W__NOTE(_D6), W__NOTE(_FS6), HALF_DOT_NOTE(_B6), E__NOTE(_REST), W__NOTE(_A6), W__NOTE(_GS6), W__NOTE(_FS6), W__NOTE(_GS6), WHOLE_DOT_NOTE(_A6),
...
#define CAPS_LOCK_ON_SOUND Q__NOTE(_B6), B__NOTE(_E7),

#define CAPS_LOCK_OFF_SOUND H__NOTE(_AS5), H__NOTE(_C6), H__NOTE(_CS6), H__NOTE(_AS5), W__NOTE(_F6), H__NOTE(_REST), W__NOTE(_F6), H__NOTE(_REST), B__NOTE(_DS6),

#define SCROLL_LOCK_ON_SOUND Q__NOTE(_G6), H__NOTE(_REST), Q__NOTE(_G6), H__NOTE(_REST), Q__NOTE(_G6), H__NOTE(_REST), BREVE_DOT_NOTE(_DS6),

#define SCROLL_LOCK_OFF_SOUND Q__NOTE(_F6), H__NOTE(_REST), Q__NOTE(_F6), H__NOTE(_REST), Q__NOTE(_F6), H__NOTE(_REST), BREVE_DOT_NOTE(_D6),

#define NUM_LOCK_ON_SOUND Q__NOTE(_E5), H__NOTE(_REST), Q__NOTE(_E5), H__NOTE(_REST), Q__NOTE(_E5), H__NOTE(_REST), BREVE_DOT_NOTE(_E6),

#define NUM_LOCK_OFF_SOUND Q__NOTE(_FS5), H__NOTE(_REST), Q__NOTE(_FS5), H__NOTE(_REST), Q__NOTE(_FS5), H__NOTE(_REST), BREVE_DOT_NOTE(_FS6),
