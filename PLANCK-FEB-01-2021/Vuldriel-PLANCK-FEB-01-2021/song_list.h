...
#define SCROLL_LOCK_ON_SOUND Q__NOTE(_E5), H__NOTE(_REST), Q__NOTE(_E5), H__NOTE(_REST), Q__NOTE(_E5), H__NOTE(_REST), BREVE_DOT_NOTE(_E6),

#define SCROLL_LOCK_OFF_SOUND Q__NOTE(_G6), H__NOTE(_REST), Q__NOTE(_G6), H__NOTE(_REST), Q__NOTE(_G6), H__NOTE(_REST), BREVE_DOT_NOTE(_DS6),

#define NUM_LOCK_ON_SOUND Q__NOTE(_FS5), H__NOTE(_REST), Q__NOTE(_FS5), H__NOTE(_REST), Q__NOTE(_FS5), H__NOTE(_REST), BREVE_DOT_NOTE(_FS6),

#define NUM_LOCK_OFF_SOUND Q__NOTE(_F6), H__NOTE(_REST), Q__NOTE(_F6), H__NOTE(_REST), Q__NOTE(_F6), H__NOTE(_REST), BREVE_DOT_NOTE(_D6),
