 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |BL Tog|Voice-|Voice+|Mus on|Musoff| LEAD | LOCK |BlueTh|Mouse4|Mouse3|Mouse2|Mouse1|
 * |------+------+------+------+------+------+------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT_planck_grid(
    ...
    BL_TOGG, KC_BRIU, KC_BRID, MU_ON,   MU_OFF,  KC_LEAD,         KC_LOCK,         OUT_AUTO,       KC_WH_L,        KC_WH_D, KC_WH_U, KC_WH_R,
